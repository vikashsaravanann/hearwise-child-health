...
export default function LearnPage() {
  ...
  return (
    ...
    >
      <div className="max-w-4xl mx-auto p-4 sm:p-5 sm:p-6 space-y-12">
        
        {/* Mini Game Section */}
        <div className="bg-white/10 backdrop-blur-md border-4 border-white/20 rounded-3xl p-6 sm:p-6 sm:p-8 text-center">
          <h2 className="text-2xl sm:text-2xl sm:text-3xl font-black text-white mb-6" style={{ fontFamily: 'Fredoka, sans-serif' }}>
            {lang === 'ta' ? 'உண்மை அல்லது பொய் விளையாட்டு' : 'True or False Mini-Game'}
          </h2>
          
          {showResult ? (
            <div className="bg-white rounded-2xl p-6 sm:p-6 sm:p-8">
              <h3 className="text-2xl sm:text-3xl font-black text-blue-900 mb-2">Quiz Complete!</h3>
        ...
        {/* Ear Care Tips Grid */}
        <div>
          <h2 className="text-2xl sm:text-2xl sm:text-3xl font-black text-white mb-6 text-center" style={{ fontFamily: 'Fredoka, sans-serif' }}>
            {lang === 'ta' ? 'காது பராமரிப்பு குறிப்புகள்' : 'Ear Care Tips'}
          </h2>
          <div className="grid grid-cols-1 sm:grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-5 sm:p-6">
            <div className="bg-white rounded-3xl p-5 sm:p-6 shadow-xl border-4 border-blue-50 hover:border-blue-200 transition-all group">
            ...
            <div className="bg-white rounded-3xl p-5 sm:p-6 shadow-xl border-4 border-emerald-50 hover:border-emerald-200 transition-all group">
            ...
            <div className="bg-white rounded-3xl p-5 sm:p-6 shadow-xl border-4 border-amber-50 hover:border-amber-200 transition-all group">
            ...
            <div className="bg-white rounded-3xl p-5 sm:p-6 shadow-xl border-4 border-purple-50 hover:border-purple-200 transition-all group">
