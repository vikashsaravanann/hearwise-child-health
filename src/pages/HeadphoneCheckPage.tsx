...
export default function HeadphoneCheckPage() {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center px-6 py-8">
      ...
      <Button variant="outline" className="mt-6 h-12 gap-2 rounded-xl" onClick={() => playSampleTone()}>
        <Volume2 size={18} />
        {t('playSampleTone', lang)}
      </Button>
      <div className="mt-auto w-full max-w-sm pt-8">
        <Button className="h-14 w-full rounded-2xl text-base font-semibold" disabled={!allChecked} onClick={() => navigate('/practice')}>
